    ...
    <div class="mt-4 mx-4">
      <div class="columns">
        <div class="column mr-4">
          <label>Course Name<span class="has-text-danger ml-1">*</span></label>
          <b-field>
            <b-input
              type="text"
              v-model="courseName"
        ...
        <div class="column">
          <label>Description<span class="has-text-danger ml-1">*</span></label>
          <b-field>
            <b-input
              type="textarea"
              v-model="description"
...
<script>
export default { name: "CreateCourseView" };
</script>
